...
| **Lives where?** | `.github/workflows/` | `.github/actions/` or separate action repository |
| **Can accept secrets directly?** | Yes | No (must pass as inputs or environment variables) |
| **Best for** | Reusing **entire workflows or jobs** across repositories | Reusing **a group of steps as a single action** |
